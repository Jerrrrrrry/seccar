...
// 此处因为datagrid的性能问题而屏蔽 2015-9-15 刘建军
...
// 行号超过1万的时候显示不开的问题解决2015-9-16 刘建军
//cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\">"+_792+"</div></td>");

if((_792+"").length>2){
    var mkm_rn_width = ((_792+"").length-2)*7+25;
    $('.datagrid-header-rownumber').width(mkm_rn_width);
    cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\" style=\"width:"+mkm_rn_width+"px;\">"+_792+"</div></td>");
}else{
    $('.datagrid-header-rownumber').width(30);
    cc.push("<td class=\"datagrid-td-rownumber\"><div class=\"datagrid-cell-rownumber\" style=\"width:30px;\">"+_792+"</div></td>");
}
}
...
},handler:function(_a4i){
$(_a4i).combo('setValue','').combo('setText',''); 
$(this).closest("div.combo-panel").panel("close");
}}],formatter:function(date){
