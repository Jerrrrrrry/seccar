...
<head>
  ...
  <script type="text/javascript" src="<%=basePath %>js/business/SumTrade/SumTrade.Init.js"></script>
  <script type="text/javascript" src="<%=basePath %>js/business/SumTrade/SumTrade.List.js"></script>
  <script type="text/javascript">

    $(function(){
    	SumTradeInit.getInstance('<%= basePath%>').init();
    }
