...
<head>
  ...
  <script type="text/javascript" src="<%=basePath %>js/business/SumLoan/SumLoan.Init.js"></script>
  <script type="text/javascript" src="<%=basePath %>js/business/SumLoan/SumLoan.List.js"></script>
  <script type="text/javascript">

    $(function(){
    	SumLoanInit.getInstance('<%= basePath%>').init();
    }
