...
public class VoucherEntry implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2358518771436769720L;

	public VoucherEntry(String bizDate, String deptNum)
	{
		this.bizDate = bizDate;
		this.deptNum = deptNum;
		this.bizNum = (bizDate+"+"+deptNum);
	}
    ...
    private BigDecimal amount;              // 本位币金?
