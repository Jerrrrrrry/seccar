...
public class Voucher implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5328424109430419397L;
	private String brNo;                    // 公司代码
    private int voucherID;                  // ID
    private Date date;                      // 凭证日期
    private int year;                       // 会计年度
    private int period;                     // 会计期间
    private int groupID;                    // 凭证字内�?
    private int number;                     // 凭证�?
    private String explanation;             // 备注
    private int attachments;                // 附件�?
    private int entryCount;                 // 分录�?
    private double debitTotal;              // 借方总金�?
    private double creditTotal;             // 贷方总金�?
