...
public class DbConnectionFactory {
	...
	public static Connection createKisConnection(){
		Connection conn = null;
		try {
			 String db_url=DbSqlHelper.DBConfig.get("kis_db_url"); 
			 String db_instance=DbSqlHelper.DBConfig.get("kis_db_instance");
			 String db_user=DbSqlHelper.DBConfig.get("kis_db_user");
			 String db_password=DbSqlHelper.DBConfig.get("kis_db_password");
